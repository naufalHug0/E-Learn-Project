...
const SideBar = ({active, handleSideBar}) => {
    const navigate = useNavigate()
    return (
        <aside className={active}>
            <div className="aside-brand">
                <h1><span>e</span>Learn</h1>
                <div className="aside-close" onClick={() => handleSideBar(false)}><CLOSE_ICON/></div>
            </div>
            <div className="aside-content">
                <div className="aside-menu">
                    <div className="aside-list" onClick={() => navigate('/account/classes')}><CLASS_ICON/> <p>Classes</p></div>
                    <div className="aside-list" onClick={() => navigate('/account/settings')}><SETTINGS_ICON/> <p>Settings</p></div>
                </div>
                <div className="aside-menu">
                    <div className="aside-list" onClick={() => navigate('/')}><BACK_ICON/> <p>Back to Home</p></div>
                    <div className="aside-list" onClick={() => {
                        logout();
                        navigate('/start');
                    }}><LOGOUT_ICON/> <p>Log out</p></div>
                </div>
            </div>
        </aside>
    )
